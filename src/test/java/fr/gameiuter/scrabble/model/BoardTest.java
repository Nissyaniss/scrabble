...
public class BoardTest {
    ...
    class ScoreTest {
        ...
        void basicCrossingWord() {
            word.put(new Position(5, 7, Direction.HORIZONTAL), new Tile(FrenchLetter.B));
            word.put(new Position(7, 7, Direction.HORIZONTAL), new Tile(FrenchLetter.T));
        ...
        void basicAddingWord() {
            word.put(new Position(5, 10, Direction.HORIZONTAL), new Tile(FrenchLetter.T));
            word.put(new Position(6, 10, Direction.HORIZONTAL), new Tile(FrenchLetter.Z));
        ...
        void withLetterMultiplier() {
            word.put(new Position(2, 5, Direction.VERTICAL), new Tile(FrenchLetter.T));
            word.put(new Position(2, 6, Direction.VERTICAL), new Tile(FrenchLetter.Z));
        ...
        void withWordMultiplier() {
            word.put(new Position(1, 1, Direction.VERTICAL), new Tile(FrenchLetter.T));
            word.put(new Position(1, 2, Direction.VERTICAL), new Tile(FrenchLetter.Z));
        ...
        void ignoreAlreadyUsedMultiplier() {
            ...
            word.put(new Position(10, 11, Direction.VERTICAL), new Tile(FrenchLetter.T));
            word.put(new Position(10, 12, Direction.VERTICAL), new Tile(FrenchLetter.Z));
        ...
        @Test
        void verticalAtZero() {
            word.put(new Position(0, 1, Direction.VERTICAL), new Tile(FrenchLetter.T));
            word.put(new Position(0, 2, Direction.VERTICAL), new Tile(FrenchLetter.Z));
        ...
        @Test
        void verticalAtMax() {
            word.put(new Position(Board.LAST_LINE_OR_COLUMN, 1, Direction.VERTICAL), new Tile(FrenchLetter.T));
            word.put(new Position(Board.LAST_LINE_OR_COLUMN, 2, Direction.VERTICAL), new Tile(FrenchLetter.Z));
        ...
        void horizontalAtBoundaries() {
            word.put(new Position(0, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.A)); // 1 * 2 = 2
            word.put(new Position(1, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.B)); // 3
            word.put(new Position(2, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.C)); // 3
            word.put(new Position(3, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.D)); // 2
            word.put(new Position(4, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.E)); // 1
            word.put(new Position(5, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.F)); // 4
            word.put(new Position(6, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.G)); // 2
            word.put(new Position(7, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.H)); // 4 * 2 = 8
            word.put(new Position(8, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.I)); // 1
            word.put(new Position(9, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.J)); // 8
            word.put(new Position(10, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.K)); // 10
            word.put(new Position(11, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.L)); // 1
            word.put(new Position(12, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.M)); // 2
            word.put(new Position(13, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.N)); // 1
            word.put(new Position(14, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.O)); // 1 * 2 = 2
        ...
        void checkJokers() {
            ...
            word.put(new Position(2, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.C)); // 3
            word.put(new Position(3, 3, Direction.HORIZONTAL), new Tile(FrenchLetter.D)); // 2
            word.put(new Position(4, 3, Direction.HORIZONTAL), new Tile('*', 0)); // 0
